...
✅ <b>На сегодня:</b>
• Название задачи
(перечисли ВСЕ задачи на сегодня, КАЖДУЮ отдельной строкой; НЕ сокращай, НЕ пиши «и ещё N задач»)
...
🔁 <b>Ежедневно:</b>
• Привычка
(перечисли ВСЕ пункты из блока ЕЖЕДНЕВНЫЕ ПРИВЫЧКИ как есть; пропусти блок если их нет)
