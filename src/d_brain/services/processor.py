...
МАППИНГ ПРОЕКТОВ АНКО (используй relation «Проект» при создании задач):
- Афанасий (пиво, лодки, парк, фестивали, Тверь): 38c289eb-342c-81b2-aeb0-fefc423df2e9
- Events (мероприятия, события, продюсирование): 38c289eb-342c-8131-9bd5-ce55d2d3df36
- Travel (туры, путешествия): 38c289eb-342c-81ae-aaa9-ff8d5072e6c8
- Wellness (УррА, Охудеть, велнес-программы): 38c289eb-342c-8183-b2d9-cad336f6ce76
- Taste (гастро, еда, дегустации): 38c289eb-342c-81a8-9608-f625a32178d8
- Culture (культура, искусство, контент-проекты): 38c289eb-342c-814d-99aa-f76485f23bce
- Бренд и маркетинг (сайт, контент, SMM, PR, дизайн): 38c289eb-342c-81be-8ccc-e9de627d4f27
- Партнёры и продажи (B2B, спонсоры, клиенты, КП): 38c289eb-342c-816f-af0a-db75769eca75
- Операционка (ИП, финансы, налоги, документы, бланки): 38c289eb-342c-813a-bd5a-c8e3bede80bd
- Личное (персональный бренд, поиск работы, личные дела): 38c289eb-342c-8180-a404-c17bbaa3cc46
...
4. Для каждой задачи задай: Задача (title), Status="Not started", Срок выполнения (если упомянут), Проект (relation на проект из маппинга выше, если определяется)
5. Верни HTML-отчёт
